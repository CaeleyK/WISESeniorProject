...
library("readr")
png(file = "/Users/caeleykardell/IdeaProjects/HomePage/MainDirectory/TwoSample.png", width = 500, height = 500)

mean1_string = read_lines("/Users/caeleykardell/IdeaProjects/HomePage/MainDirectory/TwoSampleFile", n_max=1)
mean1 = as.double(mean1_string)
sd1_string = read_lines("/Users/caeleykardell/IdeaProjects/HomePage/MainDirectory/TwoSampleFile", n_max=1, skip=1)
sd1 = as.double(sd1_string)
mean2_string = read_lines("/Users/caeleykardell/IdeaProjects/HomePage/MainDirectory/TwoSampleFile", n_max=1, skip=2)
mean2 = as.double(mean2_string)
sd2_string = read_lines("/Users/caeleykardell/IdeaProjects/HomePage/MainDirectory/TwoSampleFile", n_max=1, skip=3)
sd2 = as.double(sd2_string)
