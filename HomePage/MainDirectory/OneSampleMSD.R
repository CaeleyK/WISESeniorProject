...
library("readr")
png(file = "/Users/caeleykardell/IdeaProjects/HomePage/MainDirectory/OneSampleMSD.png", width = 500, height = 500)

mean_string = read_lines("/Users/caeleykardell/IdeaProjects/HomePage/MainDirectory/OneSampleMSDFile", n_max=1)
mean1 = as.double(mean_string)
sd_string = read_lines("/Users/caeleykardell/IdeaProjects/HomePage/MainDirectory/OneSampleMSDFile", n_max=2, skip=1)
