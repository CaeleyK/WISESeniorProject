...
public class Overview {
    ...
    public void runOverview(Stage stage) throws FileNotFoundException {
        ...
        Text dir2_1 = new Text("Directional 1: “Students with a pet dog ");
        ...
        Text nondir1 = new Text("Directional 1: “Students with a pet dog ");
        nondir1.setFont(Font.font("Verdana", 20));
        Text nondir2 = new Text("do not report different");
        ...
        //step 2: info
        Text step2info = new Text("Your level of significance is also known as your alpha (" + "\u03B1" + ") value.  Your alpha value is the maximum probability that you will reject your null hypothesis and accept your research hypothesis when the null is actually true (i.e. a “false positive”).  A commonly used level of significance is .05.  If your alpha value is .05 and you accept your research hypothesis that students with dogs are less stressed, there is a 5% chance that your result was a “false positive” and that both groups of students (with and without dogs) exhibit no significant difference in their stress levels." + "\n" + "\n");
        ...
        //step 4: title
        Text step4Title = new Text("Step 4: Find your Critical Value and Rejection Region" + "\n" + "\n");
        ...
        Text critVal2 = new Text(" This value is the number that you will be comparing your test statistic to in the next step.  To find your critical value, you will need to know your alpha value and your sample size.  Your sample size will be used to find one more variable called degrees of freedom (df), which is calculated differently for every test. \n \n" +
                "Your critical value is used to determine the rejection region.  Your rejection region represents the range of test statistics which would yield a statistically significant result." + "\n" + "\n");
        ...
        //step 5: info
        Text step5info = new Text("Take your test statistic that you calculated in step 3 and compare it to the critical value that you found in step 4.  If the absolute value of your test statistic is greater than your critical value, you can reject the null hypothesis and accept the research hypothesis.  Otherwise, you accept the null hypothesis. \n \n");
        step5info.setFont(Font.font("Verdana", 20));
        tf2.getChildren().add(step5info);
