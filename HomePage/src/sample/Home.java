...
public class Home {
    ...
    public void assembleHP(Stage homeStage) throws IOException, URISyntaxException {
        //Title
        Text appName = new Text("Hypothesis Testing: To a T");
        appName.setFont(Font.font ("Verdana", FontWeight.BOLD, 45));
        ...
        /*
        //Image line = new Image(new FileInputStream("/Users/caeleykardell/IdeaProjects/HomePage/MainDirectory/Line.png"));
        //InputStream resourceBuff = getClass().getResourceAsStream("/Users/caeleykardell/IdeaProjects/HomePage/MainDirectory/Line.png");
        //Image bf = ImageIO.read(resourceBuff);

        String ftest = new File(Home.class.getProtectionDomain().getCodeSource().getLocation().toURI()).getPath();
        String jarPath = getClass().getProtectionDomain().getCodeSource().getLocation().toURI().getPath();
        System.out.println(jarPath);
        //ftest = ftest.Remove(ftest.LastIndexOf('?'));
        int slashcounter = 0;
        String ftest2 = ftest;
        for(int i = ftest.length()-1; i >= 0; i--) {
            if (ftest.charAt(i) == '/') {
                slashcounter++;
            }
            ftest2 = ftest.substring(0, ftest2.length()-1);
            if (slashcounter == 3) {
                break;
            }
        }
        System.out.println(ftest2);
        //JarFile jar = new JarFile("HomePage.jar");
        String file = ftest + "/MainDirectory/Line.png";
        //JarEntry entry = jar.getEntry(file);
        //InputStream input = jar.getInputStream(entry);

        //Image line = new Image(new FileInputStream(file));

        //InputStream resourceBuff = getClass().getResourceAsStream(file);
        System.out.println(ftest2 + "/MainDirectory/Line.png");
        System.out.println("/Users/caeleykardell/IdeaProjects/HomePage/MainDirectory/Line.png");
        //BufferedImage imBuff = ImageIO.read(getClass().getResourceAsStream(ftest2 + "/MainDirectory/Line.png"));
        //Image line = SwingFXUtils.toFXImage(imBuff, null);

        FileInputStream in = (FileInputStream) this.getClass().getResourceAsStream("/sample/Line.png");
        System.out.println("class=" + this.getClass());
        Image line = new Image(in);
        //BufferedImage bf = ImageIO.read(in);
        //BufferedInputStream bf = new BufferedInputStream(in);
        //BufferedImage line = ImageIO.read(bf);
        //Image image = ImageIO.read(line);
        //Image line = SwingFXUtils.toFXImage(bf, null);

         */



        Image line = new Image(new FileInputStream(System.getProperty("user.dir") + "/MainDirectory/Line.png"));
        //Image line = new Image(new FileInputStream(jarPath + "/MainDirectory/Line.png"));
        ImageView line1 = new ImageView(line);
        line1.setPreserveRatio(true);
        line1.setFitWidth(homeStage.getWidth()-200);
        hp.setAlignment(Pos.CENTER);
        VBox.setMargin(line1, new Insets(0, 50, 0, 50));
        hp.getChildren().add(line1);
        ...
        Text layer5Text2 = new Text("How is the data structured?");
        ...
        text7.setPrefWidth((homeStage.getWidth()/2)-100);
        ...
        oneSampleBox.setPrefWidth((homeStage.getWidth()/2)-100);
        ...
        twoSampleBox.setPrefWidth((homeStage.getWidth()/2)-100);
        ...
        pairedBox.setPrefWidth((homeStage.getWidth()/2)-100);
