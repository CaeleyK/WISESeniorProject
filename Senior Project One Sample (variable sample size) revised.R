...
sample_size <- 150 #Java code should reject this number if it is 0,1, or 2
...
plot(x=x, y=dt(x, sample_size-1), type="l", lwd=2, col="lightblue3", frame=FALSE, ylab="Probability Density", xlab="")
